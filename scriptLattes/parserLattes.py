...
from producoesTecnicas.organizacaoDeEvento import *
...
from scriptLattes.producoesTecnicas.relatorioDePesquisa import RelatorioDePesquisa
                    ...
                    if self.achouProducoes:
                        ...
                        if self.achouProducaoTecnica:
                            ...
                            if self.achouOrganizacaoDeEvento:
                                iessimoItem = OrganizacaoDeEvento(self.idMembro, self.partesDoItem,
                                                                         self.relevante)
                                self.listaOrganizacaoDeEvento.append(iessimoItem)

                            if self.achouProgramaDeRadioOuTv:
                                iessimoItem = ProgramaDeRadioOuTv(self.idMembro, self.partesDoItem,
                                                                         self.relevante)
                                self.listaProgramaDeRadioOuTv.append(iessimoItem)

                            if self.achouRelatorioDePesquisa:
                                iessimoItem = RelatorioDePesquisa(self.idMembro, self.partesDoItem,
                                                                         self.relevante)
                                self.listaProgramaDeRadioOuTv.append(iessimoItem)
